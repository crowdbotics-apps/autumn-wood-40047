"""
Django settings for autumn_wood_40047 project.
...
ROOT_URLCONF = 'autumn_wood_40047.urls'
...
WSGI_APPLICATION = 'autumn_wood_40047.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autumn_wood_40047 API",
    "DESCRIPTION": "API documentation for autumn_wood_40047 App",
    "VERSION": "v1",
}
